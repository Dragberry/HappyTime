...
$metaDescription = '
    Студия праздников ' . MSGapplicationTitle . ' поможет Вам организовать любые торжества:
    от новогоднего поздравления Дедом Морозом до необычного признания в виде незабываемого приключения по городу Минску.
...
$headerContent = '
 <h1 class="header-title">
    <a class="" href="' . $menuActions[MSGsantaClaus]["link"] . '">
        Организация праздников и торжеств в городе Минске. Оригинальные поздравления.
    </a>
</h1>
';
$content = '
