...
$metaDescription = '
     Деда Мороз и Снегурочка на дом, утренник, корпоратив в Минске. Недорого, от 22 уе.
     Заказ новогоднего поздравления от Деда Мороза и Снегурочки.';
$activeLink=MSGаnimatorsAndToastmaster;
$activeSubLink=MSGsantaClaus;
$headerContent = '
 <h1 class="header-title">
    <a class="" href="' . $menuActions[MSGsantaClaus]["link"] . '">
        Заказ Деда Мороза на дом, утренник, корпоратив в Минске. Недорого, от 250 000 рублей.
    ...
    <div class="row text-center">
        <div class="small-12 medium-12 large-12 columns">
            <h2 class="custom-main-color">
                У нас Вы можете <strong>заказать Деда Мороза для новогоднего поздравления на дом</strong>, детский утренник или корпоратив!
            </h2>
        </div>
        <div class="small-12 medium-12 large-12 columns">
            ...
            <p>
                ...
                на новогодние праздники незабываемые эмоции и волнительные переживания! Создайте для них праздничную и мистическую атмосферу!
                Пригласите сказочных Деда Мороза и его внучку Снегурочку к себе домой!
            </p>
        </div>
        <div class="small-12 medium-12 large-12 columns">
            <p>
                В поздравление входят игры, шуточные новогодние загадки, хоровод,
        ...
        <div class="small-12 medium-8 large-6 price-panel columns">
            <h3 class="custom-alter-text-color">Наш Дед Мороз работает по <strong>самым низким ценам в городе Минске:</strong></h3>
                <span class="block">
        ...
        <div class="small-12 medium-12 large-12 price-panel columns">
            <span class="block">
                ...
                Поспешите сделать заказ на новогоднее поздравление!
            </span>
        </div>
        <div class="small-12 medium-12 large-12 columns">
        ...
        <div class="small-12 medium-12 large-12 columns">
            <h2 class="custom-main-color">
                <strong>Дед Мороз на утренник</strong> в сопровождении Снегурочки,
        ...
        <div class="small-12 medium-12 large-12 columns">
            <p>
                Уже задумались, как разукрасить рабочие будни ваших коллег или подчиненных? Ведь до Нового Года осталось совсем чуть-чуть!
                Сделайте заказ Деда Мороза в Ваш офис от студии праздников ' . MSGapplicationTitleQuotes . ' и
                и Вы запомните этот Новый Год веселым и ярким событием!
            </p>
            <p>
        ...
        <div class="small-12 medium-8 large-6 price-panel columns">
            <h3 class="custom-alter-text-color">Хотите узнать, <strong>сколько стоит заказать Деда Мороза</strong> в офис?</h3>
            <span class="block">
        ...
        <div class="small-12 medium-12 large-12 columns">
            <p>
                <span class="block">
                Для сплочения рабочего коллектива просто необходимо создавать как можно больше веселых и запоминающихся ситуаций!
                </span>
                <span class="block">
        ...
        <div class="row">
            <div class="small-12 medium-6 large-6 columns">
                <div class="price-panel"  style="height: 10em">
                    <h3 class="custom-alter-text-color">Качественный новогодний корпоратив по демократичным ценам:</h3>
                    <span class="block">
            ...
            <div class="small-12 medium-6 large-6 columns">
                <div class="price-panel"  style="height: 10em">
                    <h3 class="custom-alter-text-color">Дед Мороз и Снегурочка на корпоратив с Тамадой:</h3>
                    <span class="block">
        ...
        <div class="row valign-middle">
            <div class="small-12 medium-4 large-4 columns">
                <img class="home-image"
                    alt="Сколько стоит заказать Деда Мороза на дом, утренник, офис, корпоратив в Минске"
                    src="/images/actions/santa_calling.png">
            </div>
            <div class="small-12 medium-4 large-4 columns">
                <p>
                    ДЕД МОРОЗ ЖДЕТ ВАШИХ ЗВОНКОВ!
                </p>
            </div>
            <div class="small-12 medium-4 large-4 columns">
                <img class="home-image"
                    alt="Дед Мороз на дом, утренник, офис, корпоратив в Минске"
                    src="/images/actions/christmas_tree.png">
            </div>
        </div>
        <div id="orderSantaClaus">
            <div class="row text-center">
                <h3>Чтобы заказать Деда Мороза и Снегурочку на дом, в офис или на детский утренник,
                позвоните нам по телефонам:</h3>
                <span class="block">
                    ...
                    <form id="orderSantaForm" method="POST">
                        ...
                        <div class="large-12 columns">
                          <label>Дата и время посещения:
                            <input name="time"  id="time" type="text" placeholder="Введите удобное для Вас время" />
                          </label>
                        </div>
                        <div class="large-12 columns">
